...
class User(BaseModel):
    id: int = Field(..., ge=0, description="Уникальный идентификатор пользователя")
    ...
    role: str = Field(..., min_length=1, max_length=5, description="Роль пользователя ( admin или user)")
